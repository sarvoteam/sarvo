      ...
      <div className="container">
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '6rem', alignItems: 'flex-start' }}>
          ...
          >
            ...
            <h2 style={{ fontSize: 'clamp(2.5rem, 6vw, 4.5rem)', lineHeight: 1.1, fontWeight: 900, marginBottom: '2rem', letterSpacing: '-0.03em' }}>
              Engineering the <span className="gradient-text">Future</span> of Digital Excellence
            </h2>
            
            <p style={{ fontSize: '1.25rem', color: 'var(--text-secondary)', lineHeight: 1.8, marginBottom: '2.5rem', maxWidth: '550px' }}>
            ...
            {/* Micro Stats */}
            <div style={{ display: 'flex', gap: '4rem', borderTop: '1px solid var(--glass-border)', paddingTop: '2.5rem', marginTop: '1rem' }}>
              <div>
                <h4 style={{ fontSize: '2.5rem', fontWeight: 900, marginBottom: '0.5rem', background: 'linear-gradient(135deg, #fff, #4f46e5)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>99%</h4>
                <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', textTransform: 'uppercase', letterSpacing: '0.15em', fontWeight: 700 }}>Client Success</p>
              </div>
              <div>
                <h4 style={{ fontSize: '2.5rem', fontWeight: 900, marginBottom: '0.5rem', background: 'linear-gradient(135deg, #fff, #0ea5e9)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>24/7</h4>
                <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', textTransform: 'uppercase', letterSpacing: '0.15em', fontWeight: 700 }}>Expert Support</p>
              </div>
            </div>
          </motion.div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem', marginTop: '2rem' }}>
            {values.map((value, idx) => (
              ...
              >
                ...
                <h3 style={{ fontSize: '1.4rem', marginBottom: '1rem', fontWeight: 800 }}>{value.title}</h3>
                <p style={{ fontSize: '1rem', color: 'var(--text-secondary)', lineHeight: 1.7 }}>{value.desc}</p>
              </motion.div>
            ))}
          </div>
